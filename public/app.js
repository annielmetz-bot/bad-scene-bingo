...
const BUILTIN_TEMPLATES = [
  ...
  {
    emoji: '😬',
    title: 'Conversation with My Mother',
    items: [
      'You look like you\'ve gained/lost weight?',
      'You look tired',
      'When are you getting married/having kids?',
      'Someone you barely know just got engaged/promoted/bought a house',
      'Guilt trip about not calling enough',
      '"I don\'t want to interfere, but..."',
      '"I\'m not going to be around forever"',
      '"I just worry about you"',
      'Unsolicited advice about your relationship',
      'Passive-aggressive comment dressed as a compliment',
      'Retells a story you\'ve heard 100 times',
      '"I saw something on Facebook that made me think of you"',
      'Health update about a relative you barely know',
      '"Your father was the same way"',
      'Brings up something embarrassing you did as a child',
      'Asks if you\'ve seen a doctor',
      'Mentions your ex',
      '"When I was your age..."',
      '"I\'m not trying to guilt you, but..."',
      'Asks a question then answers it herself',
      '"I just want you to be happy"',
      'Something you said 10 years ago is brought up',
      '"Would you feel better if you put on some blush?"',
      'Does not apologize',
    ],
  },
  {
